...
public class TutorsS extends JFrame {
	...
	public TutorsS() {
		...
		id = new JTextField();
		id.setColumns(10);
		id.setBounds(434, 146, 170, 19);
		contentPane.add(id);
		
		username = new JTextField();
		username.setColumns(10);
		username.setBounds(433, 196, 170, 19);
		contentPane.add(username);
		
		email = new JTextField();
		email.setColumns(10);
		email.setBounds(434, 246, 170, 19);
		...
		btnNewButton_2_2.setBounds(633, 183, 140, 45);
		...
		btnNewButton_2.setBounds(783, 183, 140, 45);
		...
		btnNewButton_2_1.setBounds(933, 183, 140, 45);
		...
		btnNewButton_1.setBounds(519, 287, 85, 21);
		...
		btnNewButton_2_2_1.setBounds(783, 245, 140, 45);
