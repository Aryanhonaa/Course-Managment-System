...
public class SignUp extends JFrame{
	...
	public SignUp() {
		...
		lblNewLabel.setBounds(212, 30, 290, 58);
		lblNewLabel.setFont(new Font("Serif", Font.BOLD, 32));
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Username\r\n");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 23));
		lblNewLabel_1.setBounds(72, 180, 160, 26);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_1_1 = new JLabel("Password");
		lblNewLabel_1_1.setFont(new Font("Tahoma", Font.PLAIN, 23));
		lblNewLabel_1_1.setBounds(72, 270, 160, 26);
		contentPane.add(lblNewLabel_1_1);
		
		JLabel lblNewLabel_1_2 = new JLabel("Email\r\n");
		lblNewLabel_1_2.setFont(new Font("Tahoma", Font.PLAIN, 23));
		lblNewLabel_1_2.setBounds(72, 340, 160, 26);
		contentPane.add(lblNewLabel_1_2);
		
		JLabel lblNewLabel_1_3 = new JLabel("Select Mode");
		lblNewLabel_1_3.setFont(new Font("Tahoma", Font.PLAIN, 23));
		lblNewLabel_1_3.setBounds(72, 420, 160, 26);
		contentPane.add(lblNewLabel_1_3);
		
		JLabel lblNewLabel_1_4 = new JLabel("Course");
	    lblNewLabel_1_4.setFont(new Font("Tahoma", Font.PLAIN, 23));
	    lblNewLabel_1_4.setBounds(72, 500, 160, 26);
	    ...
	    courseTextField.setBounds(226, 500, 359, 28);
	    contentPane.add(courseTextField);
	    courseTextField.setVisible(false);
		
		textUsername = new JTextField();
		textUsername.setBounds(226, 180, 359, 28);
		contentPane.add(textUsername);
		textUsername.setColumns(10);
		
		mail = new JTextField();
		mail.setColumns(10);
		mail.setBounds(226, 340, 359, 28);
		...
		textField.setBounds(226, 250, 359, 19);
		...
		lblNewLabel_3.setBounds(226, 160, 350, 18);
		...
		checkMail.setBounds(226, 325, 359, 13);
		...
		comboBox.setBounds(226, 420, 359, 26);
		contentPane.add(comboBox);
		
		textPassword = new JPasswordField();
		textPassword.setBounds(226, 270, 359, 28);
		...
		btnNewButton.setBounds(93, 630, 192, 58);
		...
		btnLogin.setBounds(384, 630, 192, 58);
		contentPane.add(btnLogin);
		
		JLabel lblNewLabel_2 = new JLabel("Already registerd");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.BOLD, 15));
		lblNewLabel_2.setBounds(398, 600, 165, 26);
		...
		btnNewButton_1.setBounds(473, 550, 117, 21);
